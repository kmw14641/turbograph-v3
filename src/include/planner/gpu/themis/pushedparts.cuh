...
struct PushedPartsAtLoopLvl {
    ...
    volatile int end[64];
    __forceinline__ __device__ char *GetAttrsPtr()
    {
        return ((char *)this) + sizeof(PushedPartsAtLoopLvl);
    }
};
...
struct PushedPartsAtIfLvl {
    ...
    __forceinline__ __device__ char *GetAttrsPtr()
    {
        return ((char *)this) + sizeof(PushedPartsAtIfLvl);
    }
};
...
struct PushedPartsStack {
    ...
    __forceinline__ __device__ void FreeLock() { atomicCAS(&lock, 1, 0); }
    ...
    __forceinline__ __device__ PushedParts *Top()
...
__global__ void Krnl_InitPushedPartsStack(PushedPartsStack *stack,
                                          size_t size_per_warp,
                                          size_t num_warps)
{
